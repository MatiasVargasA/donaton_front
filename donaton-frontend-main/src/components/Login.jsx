            ...
            <form className="flex flex-col gap-stack-md" onSubmit={handleLogin}>
              ...
              <div className="flex flex-col gap-stack-xs">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full pl-10 pr-4 py-3 bg-white border border-outline-variant rounded focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all font-body-md text-body-md"
                    id="email"
                    name="email"
              ...
              <div className="flex flex-col gap-stack-xs">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full pl-10 pr-10 py-3 bg-white border border-outline-variant rounded focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all font-body-md text-body-md"
                    id="password"
                    name="password"
                    placeholder="••••••••"
                    type="password"
